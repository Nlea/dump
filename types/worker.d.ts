/* eslint-disable */
// Generated by Wrangler by running `wrangler types types/worker.d.ts` (hash: f809e89420510a2afc9430cfbbefbcf9)
// Runtime types generated with workerd@1.20250428.0 2025-02-04 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		FPX_ENDPOINT: string;
		OPENAI_API_FOO: string;
